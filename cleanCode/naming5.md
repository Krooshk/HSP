...
operation - calculate // Посчитать результат на основе оператора  
round - rotate // Повращать очередь  
amount - getCountFilledEntries // Получить количество заполненных ячеек массива  
mostFrequently - getMostFrequentlyElems // Получить наиболее часто встречающиеся элементы  
unionFilter - getUnionBlumFilter // Получить объединенный Блум фильтер  
circular - checkForCircularity // Проверить на круговую зависимость  
