...
-- 9.4.1. 
--   Найдите все пары из разных (уникальных) заказчиков (Customers), 
...
-- 9.4.2. 
--   Найдите вложенным запросом список заказов (Orders), 
...
-- 9.4.3. 
--   Немного условный, но показательный пример. Найдите все заказы (таблица Orders), 
--   цена за доставку товара которых (Freight) превышает цену любого товара (поле UnitPrice, таблица Products).
SELECT * FROM Orders t1
